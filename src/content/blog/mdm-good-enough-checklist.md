...
* [What "Good Enough" Actually Means in MDM](#what-good-enough-actually-means-in-mdm)
* [Section 1: Data Quality Fundamentals](#section-1-data-quality-fundamentals)
  * [Completeness Thresholds Are Defined and Enforced](#completeness-thresholds-are-defined-and-enforced)
  * [Standardization Rules Are Documented and Version-Controlled](#standardization-rules-are-documented-and-version-controlled)
  * [Data Quality Scores Are Tied to Business Impact, Not Just Technical Metrics](#data-quality-scores-are-tied-to-business-impact-not-just-technical-metrics)
  * [Source System Quality Issues Are Tracked Back to Their Origin](#source-system-quality-issues-are-tracked-back-to-their-origin)
  * [Reference Data Is Governed and Synchronized](#reference-data-is-governed-and-synchronized)
* [Section 2: Matching and Survivorship](#section-2-matching-and-survivorship)
  * [Match Rules Are Documented and Regularly Reviewed](#match-rules-are-documented-and-regularly-reviewed)
  * [Survivorship Logic Is Business-Aligned, Not Just Technical](#survivorship-logic-is-business-aligned-not-just-technical)
  * [Suspect Duplicate Queue Is Being Worked and Not Just Growing](#suspect-duplicate-queue-is-being-worked-and-not-just-growing)
  * [Merge History Is Tracked and Reversible](#merge-history-is-tracked-and-reversible)
  * [Cross-Domain Matching Is Governed, Not Ad Hoc](#cross-domain-matching-is-governed-not-ad-hoc)
* [Section 3: Governance Integration](#section-3-governance-integration)
  * [Every Master Data Domain Has a Named Data Owner](#every-master-data-domain-has-a-named-data-owner)
  * [Stewardship Workflows Are Connected to the Governance Framework](#stewardship-workflows-are-connected-to-the-governance-framework)
  * [Data Definitions Are Managed in a Business Glossary, Not in the MDM Tool](#data-definitions-are-managed-in-a-business-glossary-not-in-the-mdm-tool)
  * [Data Lineage Is Documented from Source to Golden Record to Consumption](#data-lineage-is-documented-from-source-to-golden-record-to-consumption)
  * [MDM Policies Are Documented, Reviewed, and Tied to Business Requirements](#mdm-policies-are-documented-reviewed-and-tied-to-business-requirements)
* [Section 4: Business Consumption and Value Realization](#section-4-business-consumption-and-value-realization)
  * [Downstream Systems Are Consuming from the Hub, Not the Source](#downstream-systems-are-consuming-from-the-hub-not-the-source)
  * [Master Data Latency Meets Business Requirements](#master-data-latency-meets-business-requirements)
  * [Business Users Can Self-Serve on Master Data Questions](#business-users-can-self-serve-on-master-data-questions)
  * [MDM Program Value Is Measured and Communicated to Stakeholders](#mdm-program-value-is-measured-and-communicated-to-stakeholders)
  * [Data Consumers Know Where Master Data Comes From and How to Challenge It](#data-consumers-know-where-master-data-comes-from-and-how-to-challenge-it)
* [Section 5: Operational Health and Program Sustainability](#section-5-operational-health-and-program-sustainability)
  * [Hub Performance Is Monitored and Trending in the Right Direction](#hub-performance-is-monitored-and-trending-in-the-right-direction)
  * [Source System Changes Are Managed Through a Formal Change Process](#source-system-changes-are-managed-through-a-formal-change-process)
  * [The MDM Platform Is on a Supported Version](#the-mdm-platform-is-on-a-supported-version)
  * [Disaster Recovery Has Been Tested, Not Just Documented](#disaster-recovery-has-been-tested-not-just-documented)
  * [Program Staffing Is Not Critically Dependent on One or Two Individuals](#program-staffing-is-not-critically-dependent-on-one-or-two-individuals)
  * [There Is a Defined Process for New Source System Onboarding](#there-is-a-defined-process-for-new-source-system-onboarding)
* [How to Score and Use This Checklist](#how-to-score-and-use-this-checklist)
* [The Practitioner's Honest Assessment](#the-practitioners-honest-assessment)
