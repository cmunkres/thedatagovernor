...
* [How Claude Pricing Has Evolved](#how-claude-pricing-has-evolved)
* [Understanding Claude's Model Lineup](#understanding-claudes-model-lineup)
  * [Claude Opus 4.6: The Flagship](#claude-opus-46-the-flagship)
  * [Claude Sonnet 4.6: The Workhorse](#claude-sonnet-46-the-workhorse)
  * [Claude Haiku 4.5: The Speed Tier](#claude-haiku-45-the-speed-tier)
* [Individual Plans: Free, Pro, and Max](#individual-plans-free-pro-and-max)
  * [The Free Plan](#the-free-plan)
  * [Claude Pro — $20/Month ($17/Month Annual)](#claude-pro--20month-17month-annual)
  * [Claude Max — $100/Month (5x) or $200/Month (20x)](#claude-max--100month-5x-or-200month-20x)
* [Team Plans](#team-plans)
  * [Standard Seats — $25/Month ($20/Month Annual)](#standard-seats--25month-20month-annual)
  * [Premium Seats — $150/Month ($100/Month Annual)](#premium-seats--150month-100month-annual)
  * [Team Plan Features](#team-plan-features)
* [Enterprise Plans](#enterprise-plans)
  * [What Changed](#what-changed)
  * [What This Means in Practice](#what-this-means-in-practice)
  * [Enterprise Features](#enterprise-features)
  * [Navigating the Enterprise Pricing Transition](#navigating-the-enterprise-pricing-transition)
* [API Pricing: Pay-Per-Token](#api-pricing-pay-per-token)
  * [Current API Token Pricing (April 2026)](#current-api-token-pricing-april-2026)
  * [Extended Thinking Tokens](#extended-thinking-tokens)
  * [Real-World Cost Examples](#real-world-cost-examples)
* [Cost Optimization: Cutting Your API Bill by Up to 95%](#cost-optimization-cutting-your-api-bill-by-up-to-95)
  * [Prompt Caching](#prompt-caching)
  * [Batch API](#batch-api)
  * [Combined Optimization](#combined-optimization)
  * [Other Optimization Strategies](#other-optimization-strategies)
* [Comparing Claude to Competitors](#comparing-claude-to-competitors)
  * [Consumer Plan Comparison](#consumer-plan-comparison)
  * [API Pricing Comparison](#api-pricing-comparison)
  * [DeepSeek and Open-Source Alternatives](#deepseek-and-open-source-alternatives)
  * [The Right Framework for Comparison](#the-right-framework-for-comparison)
* [Which Plan Should You Choose?](#which-plan-should-you-choose)
  ...
  * [For Developers Building Applications](#for-developers-building-applications)
* [Hidden Costs and Gotchas](#hidden-costs-and-gotchas)
  * [Rolling Window Limits](#rolling-window-limits)
  * [Peak Hour Throttling](#peak-hour-throttling)
  * [Extended Thinking Costs](#extended-thinking-costs)
  * [Enterprise Usage-Based Billing](#enterprise-usage-based-billing)
  * [Third-Party Framework Restrictions](#third-party-framework-restrictions)
  * [Context Window Costs](#context-window-costs)
* [Building a Cost Model: Forecasting Your Claude Spend](#building-a-cost-model-forecasting-your-claude-spend)
  * [Subscription Cost Modeling](#subscription-cost-modeling)
  * [API Cost Modeling](#api-cost-modeling)
* [Claude Pricing for Data Teams: A Practitioner's Perspective](#claude-pricing-for-data-teams-a-practitioners-perspective)
  * [Data Governance and Cataloging Use Cases](#data-governance-and-cataloging-use-cases)
  * [Claude Code for Data Engineering](#claude-code-for-data-engineering)
  * [Enterprise Data Platform Evaluation](#enterprise-data-platform-evaluation)
  * [Collibra and Profisee Integration Costs](#collibra-and-profisee-integration-costs)
  * [Building the Business Case for Your CFO](#building-the-business-case-for-your-cfo)
* [Frequently Asked Questions](#frequently-asked-questions)
  * [How many messages can I send on the Free plan?](#how-many-messages-can-i-send-on-the-free-plan)
  * [Is Claude Code included with Pro?](#is-claude-code-included-with-pro)
  * [Can I use Opus on the Free plan?](#can-i-use-opus-on-the-free-plan)
  * [How does Claude's 1 million token context window affect pricing?](#how-does-claudes-1-million-token-context-window-affect-pricing)
  * [What's the cheapest way to use Claude for high-volume workloads?](#whats-the-cheapest-way-to-use-claude-for-high-volume-workloads)
  * [How does the April 2026 Enterprise pricing change affect existing customers?](#how-does-the-april-2026-enterprise-pricing-change-affect-existing-customers)
  * [Is Claude Cowork available on all paid plans?](#is-claude-cowork-available-on-all-paid-plans)
  * [How do I choose between the API and a subscription plan?](#how-do-i-choose-between-the-api-and-a-subscription-plan)
  * [Can I mix Standard and Premium seats on the Team plan?](#can-i-mix-standard-and-premium-seats-on-the-team-plan)
  * [Does Claude display ads?](#does-claude-display-ads)
  * [What happens if I exceed my usage limits?](#what-happens-if-i-exceed-my-usage-limits)
  * [Are there any student or nonprofit discounts?](#are-there-any-student-or-nonprofit-discounts)
  * [How does prompt caching work in practice?](#how-does-prompt-caching-work-in-practice)
  * [What's the difference between Claude Code and Cowork?](#whats-the-difference-between-claude-code-and-cowork)
  * [Can I use Claude through Amazon Bedrock or Google Cloud?](#can-i-use-claude-through-amazon-bedrock-or-google-cloud)
  * [How do I estimate my token usage before committing?](#how-do-i-estimate-my-token-usage-before-committing)
  * [What's the Batch API and when should I use it?](#whats-the-batch-api-and-when-should-i-use-it)
